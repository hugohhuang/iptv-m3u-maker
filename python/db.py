...
class DataBase (object) :
    ...
    def create (self) :
        ...
        sql = 'create table ' + self.table + ' (id integer PRIMARY KEY autoincrement,gp text, title text, quality text, url text, level integer, cros integer,  enable integer, online integer, delay integer, udTime text)'
